  ...
  <div style={styles.card}>
    ...
    {priceAlerts.map((alert) => {
      ...
      if (alert.changeType === "priceDrop") {
        icon = "📉";
        priceInfo = `R$ ${alert.oldPrice.toFixed(
          2
    ...
    <div style={styles.appContainer}>
      ...
      <nav style={styles.sidebar}>
        <div style={styles.sidebarContent}>
          ...
          {/* Botão Chat */}
          <a href="/chat" style={styles.sidebarButton}>
            <span style={styles.sidebarIcon}>💬</span>
            <span style={styles.sidebarText}>Chat</span>
          </a>
          {/* Botão Analytics */}
          <a href="/analytics" style={styles.sidebarButton}>
            <span style={styles.sidebarIcon}>📊</span>
            <span style={styles.sidebarText}>Analítico</span>
          </a>
          {/* Botão Perfil */}
          <a href="/profile" style={styles.sidebarButton}>
            <span style={styles.sidebarIcon}>👤</span>
...
const styles = {
  ...
  infoButton: {
    ...
    // Estilo hover simulado (adicionado para estética, embora não seja funcional em CSS-in-JS estático)
